import{s as r,u as m,i as g,f as $}from"./assets/icons-1a7ac7ca.js";import"./assets/vendor-99d50140.js";const u="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",w="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",M="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",S="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",T="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",E="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png",b=document.querySelector(".modal-cart-submit"),q=document.querySelector(".cart-modal-content"),o=document.getElementById("cart-content");o.addEventListener("click",j);document.querySelector(".cart_products_container");const v=document.querySelector(".cart-quentity");let e=r.getFromStorage("cart");function j(t){t.target.closest(".cart-delete-all-button")&&(r.clearCart(),m(),v.textContent="Cart(0)",o.innerHTML=l())}function f(){if(e){const t=e.length;v.textContent=`Cart (${t})`}}f();function y(){let t=0;return e&&e.forEach(s=>{t+=s.price}),t.toFixed(2)}function H(){e&&e.length!==0?o.innerHTML=_():o.innerHTML=l()}H();const U=o.querySelector(".cart_products_list");h();function _(){const t=y();return`<div class="products_container">
  ...
  <div class="products_order_container">      
    ...
    </li>`}).join("");if(e.length===0)return;U.innerHTML=t,document.querySelectorAll(".cart-delete-button").forEach(c=>c.addEventListener("click",F))}}function F(t){const s=t.target.closest("li").id;r.removeFromCart(s),m(),e=r.getFromStorage("cart"),e.length===0&&(o.innerHTML=l());const c=document.querySelector(".cart-sum-number");c&&(c.textContent=y()),_(),h(),f()}function l(){return`  
  <div class="box-img">
    <picture>
...
</div>`}if(document.querySelector(".order-form")){let s=function(c){c.preventDefault();const i=r.getCart().map(a=>({productId:a._id,amount:1})),n=document.querySelector(".cart-email");n.value&&$.order(n.value,i).then(a=>{const d=a.data.message;r.clearCart(),m(),v.textContent="Cart(0)",o.innerHTML=l(),q.innerHTML=I(d),R()}).catch(a=>{console.log(a)}).finally()};document.querySelector(".order-form").addEventListener("submit",s)}function R(){b.style.display="block",document.body.classList.add("no-scroll"),document.addEventListener("keydown",k),window.addEventListener("click",x)}function p(){b.style.display="none",document.removeEventListener("keydown",k),window.removeEventListener("click",x),document.body.classList.remove("no-scroll")}function k(t){t.key==="Escape"&&p()}function x(t){(t.target.classList.contains("cart-modal-content")||t.target.closest(".cart-delete-modal"))&&p()}function I(t){let s=t.substring(0,t.indexOf("Thank you for shopping")),c=t.substring(t.indexOf("Thank you for shopping"));return s=s.toUpperCase().replace("!",""),`
