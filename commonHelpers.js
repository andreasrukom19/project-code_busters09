import{s as r,u as p,i as d,f as _}from"./assets/icons-e2f6d909.js";import"./assets/vendor-99d50140.js";const u="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",k="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",x="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",C="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",$="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",L="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png",c=document.getElementById("cart-content");c.addEventListener("click",w);document.querySelector(".cart_products_container");const m=document.querySelector(".cart-quentity");let e=r.getFromStorage("cart");function w(t){t.target.closest(".cart-delete-all-button")&&(r.clearCart(),p(),m.textContent="Cart(0)",c.innerHTML=l())}function g(){if(e){const t=e.length;m.textContent=`Cart (${t})`}}g();function v(){let t=0;return e&&e.forEach(a=>{t+=a.price}),t.toFixed(2)}function S(){e.length!==0?c.innerHTML=b():c.innerHTML=l()}S();const M=c.querySelector(".cart_products_list");y();function b(){const t=v();return`<div class="products_container">
