import{s as a,i as l}from"./assets/icons-3903b6d4.js";import"./assets/vendor-99d50140.js";const o="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",_="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",b="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",v="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",y="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",h="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png";document.querySelector(".cart_close_all");const r=document.getElementById("cart-content");document.querySelector(".cart_products_container");const f=document.querySelector(".cart-quentity");let t=a.getFromStorage("cart");console.log(t);function x(){if(t){const e=t.length;f.textContent=`Cart (${e})`}}x();function $(){let e=document.querySelector(".cart-sum-number"),s=0;t&&t.forEach(c=>(s+=c.price,e.textContent=`$${s}`))}function i(){t?r.innerHTML=w():r.innerHTML=L()}i();const k=r.querySelector(".cart_products_list");n();$();function w(){return`<div class="products_container">
