import{s as r,u as p,i as m,f as $}from"./assets/footer-send-ce67ce3f.js";import"./assets/vendor-cfb45d56.js";const b="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",w="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",M="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",S="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",T="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",E="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png",q="/project-code_busters09/assets/cart-modal-a27bffcd.png",v=document.querySelector(".modal-cart-submit"),j=document.querySelector(".cart-modal-content"),o=document.getElementById("cart-content");o.addEventListener("click",H);document.querySelector(".cart_products_container");const g=document.querySelector(".cart-quentity");let e=r.getFromStorage("cart");function H(t){t.target.closest(".cart-delete-all-button")&&(r.clearCart(),p(),g.textContent="Cart(0)",o.innerHTML=l())}function f(){if(e){const t=e.length;g.textContent=`Cart (${t})`}}f();function _(){let t=0;return e&&e.forEach(s=>{t+=s.price}),t.toFixed(2)}function U(){e&&e.length!==0?o.innerHTML=y():o.innerHTML=l()}U();const F=o.querySelector(".cart_products_list");h();function y(){const t=_();return`<div class="products_container">
