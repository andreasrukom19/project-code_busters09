import{s as c,u as d,i as m,f as h}from"./assets/icons-b283792f.js";import"./assets/vendor-99d50140.js";const p="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",x="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",C="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",k="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",$="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",L="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png",r=document.getElementById("cart-content");r.addEventListener("click",S);document.querySelector(".cart_products_container");const u=document.querySelector(".cart-quentity");let e=c.getFromStorage("cart");function S(t){t.target.closest(".cart-delete-all-button")&&(c.clearCart(),d(),u.textContent="Cart(0)",r.innerHTML=n())}function g(){if(e){const t=e.length;u.textContent=`Cart (${t})`}}g();function v(){let t=0;return e&&e.forEach(o=>{t+=o.price}),t.toFixed(2)}function w(){e?r.innerHTML=b():r.innerHTML=n()}w();const M=r.querySelector(".cart_products_list");_();function b(){const t=v();return`<div class="products_container">
