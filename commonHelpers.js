import{s as r,u as g,i as u,f as L}from"./assets/icons-2882520d.js";import"./assets/vendor-99d50140.js";const p="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",$="/project-code_busters09/assets/yellow_basket_desctop_1x-min-6400acde.png",w="/project-code_busters09/assets/yellow_basket_mobile_1x-min-195418a1.png",M="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",S="/project-code_busters09/assets/yellow_basket_desctop_2x-min-91220a6c.png",q="/project-code_busters09/assets/yellow_basket_mobile_2x-min-566aede4.png",b=document.querySelector(".modal"),E=document.querySelector(".modal-content"),a=document.getElementById("cart-content");a.addEventListener("click",j);document.querySelector(".cart_products_container");const v=document.querySelector(".cart-quentity");let e=r.getFromStorage("cart");function j(t){t.target.closest(".cart-delete-all-button")&&(r.clearCart(),g(),v.textContent="Cart(0)",a.innerHTML=l())}function y(){if(e){const t=e.length;v.textContent=`Cart (${t})`}}y();function f(){let t=0;return e&&e.forEach(c=>{t+=c.price}),t.toFixed(2)}function T(){e&&e.length!==0?a.innerHTML=h():a.innerHTML=l()}T();const H=a.querySelector(".cart_products_list");_();function h(){const t=f();return`<div class="products_container">
